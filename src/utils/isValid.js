...
const isValid = (chain) => {
    ...
    for(let i = 1; i<chain.length; i++){
        ...
        if(currBlock.prevHash != prevBlock.hashSelf()){
            console.log(`Something invalid with link between block no. ${prevBlock.height} and ${currBlock.height}`)
            console.log(currBlock.height, currBlock.prevHash, prevBlock.hashSelf());
            return false;
        }
